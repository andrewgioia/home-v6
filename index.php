            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <menu class="navigation">
                        <div class="inner">
                            <a href="#me" class="item self">
                                <span class="default">Biography</span>
                                <i class="fa fa-info-circle narrow"></i>
                            </a>
                            <a href="#pj" class="item self">
                                <span class="default">Projects</span>
                                <i class="fa fa-database narrow"></i>
                            </a>
                            <a href="#em" class="item self">
                                <span class="default">Contact Me</span>
                                <i class="fa fa-envelope narrow"></i>
                            </a>
                    ...
                    <aside class="relative-position top-1">
                        <a href="javascript:;" id="open" class="white-text closed">
                            <i class="fa fa-navicon"></i>
                        </a>
                    </aside>
                    <aside class="hide-768">
...
<?php   endif; ?>
        ...
        <article id="pj">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xs-12 col-sm-10 col-sm-offset-1 centered-text">
                        <h1>Projects and Other Work</h1>
                    </div>
                    <div class="col-xs-12 col-xs-offset-0 col-sm-8 col-sm-offset-2 centered-text top-padding-10">
                    ...
                    <div class="col-sm-8 col-sm-offset-2 centered-text top-padding-10">
                        ...
                        <ol class="projects left-justified">
                            <li>
                                <a href="http://medium.com/particle-bits" class="title-font no-border">Particle Bits</a>&mdash;budding blog with Mike on web development, design, technology, and internet thoughts. <em>See also</em> <a href="http://medium.com/@andrewgioia">medium.com/@andrewgioia</a>.
                            </li>
                            <li>
